...
object Test {
  ...
  def clean(s: Any) = ("" + s).replaceAllLiterally("java.lang.", "jl.").replaceAllLiterally("public ", "")
  ...
  def methods(c: Class[_]) = c.getMethods filterNot (_.getDeclaringClass == classOf[Object]) sortBy (m => (m.getDeclaringClass.getName, m.getName, m.isBridge))
