...
object Async {
  ...
  def impl(c: blackbox.Context)(body: c.Tree)(executionContext: c.Tree): c.Tree = {
    ...
    q"""
      final class $name extends _root_.scala.tools.nsc.async.FutureStateMachine($executionContext) {
...
abstract class FutureStateMachine(execContext: ExecutionContext) extends AsyncStateMachine[Future[AnyRef], Try[AnyRef]] with Function1[Try[AnyRef], Unit] {
