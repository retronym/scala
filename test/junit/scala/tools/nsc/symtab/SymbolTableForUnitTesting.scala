...
class SymbolTableForUnitTesting extends SymbolTable {
  ...
  def flatClassPath: ClassPath = platform.classPath
  ...
  object platform extends backend.Platform {
    ...
    private[nsc] lazy val classPath: ClassPath = new PathResolverBase(settings).result
  ...
  class GlobalMirror extends Roots(NoSymbol) {
    ...
    def rootLoader: LazyType = new loaders.PackageLoader(ClassPath.RootPackage, flatClassPath)
