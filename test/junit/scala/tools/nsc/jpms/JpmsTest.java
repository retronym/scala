...
public class JpmsTest extends BaseJpmsTest {
    ///
    public static final String OUTPUT_DIR = null;
    public static final boolean RUN_JAVAC = true;
...
//                        fail(testName()+": Unexpected success from javac");
                        fail(": Unexpected success from javac");
                    }
    ...
    public void testAPILeakDetection1() {
        ...
        writeFileCollecting(files, moduleLoc + File.separator + "p" + File.separator + "exp", "C1.java",
                "package p.exp;\n" +
                        "import p.priv.*;\n" +
                        "class C0 {\n" +
                        "	@Test public void test(C0 c) {}\n" +
                        "}\n" +
                        "public class C1 {\n" +
                        "	public C2 f;\n" +
                        "	@Test public void test1(C0 c) {}\n" +
                        "	@Test public void test2(C2 c) {}\n" +
