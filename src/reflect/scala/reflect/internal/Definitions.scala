...
trait Definitions extends api.StandardDefinitions {
  ...
  trait ValueClassDefinitions {
    ...
    def isNumericValueClass(sym: Symbol) = containsEqList(ScalaNumericValueClasses, sym)
  ...
  // A type function from T => Class[U], used to determine the return
    ...
    def isPrimitiveValueClass(sym: Symbol) = containsEqList(ScalaValueClasses, sym)
