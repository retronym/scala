...
public  class LambdaDeserializer$ {
   ...
   */
  public static final LambdaDeserializer$ MODULE$ = null;
  public   LambdaDeserializer$ () { throw new RuntimeException(); }
  /**
   ...
   */
  public  java.lang.Object deserializeLambda (java.lang.invoke.MethodHandles.Lookup lookup, java.util.Map<java.lang.String, java.lang.invoke.MethodHandle> cache, java.lang.invoke.SerializedLambda serialized) { throw new RuntimeException(); }
  private  java.lang.String ScalaSerializable () { throw new RuntimeException(); }
  private  java.lang.String JavaIOSerializable () { throw new RuntimeException(); }
  private  java.lang.invoke.MethodHandle findMember (java.lang.invoke.MethodHandles.Lookup lookup, int kind, java.lang.Class<?> owner, java.lang.String name, java.lang.invoke.MethodType signature) { throw new RuntimeException(); }
}
