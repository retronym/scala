...
trait ScalaSettings extends AbsScalaSettings
  ...
  val YindySymbolLiteral = BooleanSetting("-Yindy-symbol-literal", "Use invoke dynamic to cache symbol literals, rather than a static field in the enclosing class")
  val YindyStructuralCall = BooleanSetting("-Yindy-structural-call", "Use invoke dynamic to perform reflective calls to structural types. Requires https://github.com/szegedi/dynalink at runtime.")
