...
trait ScalaSettings extends AbsScalaSettings
  ...
  object YoptChoices extends MultiChoiceEnumeration {
    val unreachableCode         = Choice("unreachable-code",          "Eliminate unreachable code, exceptionj handlers protecting no instructions, debug information of eliminated variables.")
