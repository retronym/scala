...
object ZippedIterable3 {
  //TODO does this still make sense in the new design?
  implicit def zippedIterable3ToIterable[El1, El2, El3](zz: ZippedIterable3[El1, El2, El3]): Iterable[(El1, El2, El3)] = {
    new scala.collection.AbstractIterable[(El1, El2, El3)] {
      ...
      protected[this] def fromSpecificIterable(coll: Iterable[(El1, El2, El3)]) = Iterable.from(coll)
      def iterableFactory = Iterable
      protected[this] def newSpecificBuilder() = Iterable.newBuilder()
    }
  }
}
