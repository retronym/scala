...
public final class StructuralCallSite {
    ...
    public static CallSite bootstrap(MethodHandles.Lookup lookup, String invokedName,
                                     MethodType invokedType, String reflectiveCallTypeDesc) throws Throwable {
        StructuralCallSite structuralCallSite = new StructuralCallSite(MethodType.fromMethodDescriptorString(reflectiveCallTypeDesc, lookup.lookupClass().getClassLoader()));
